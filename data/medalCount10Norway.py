...
#Total Medal Trends for Norway - Last 10 Olympic Games
...
with open('medalCount10Norway.csv') as csvfile:
	...
	for row in reader:
		if line_count is 0:
			...
			if (row[0] == "1980") and (row[4] == "NOR"):
				print("1980 Medal for NOR!")
				m_1980 += 1
			elif (row[0] == "1984") and (row[4] == "NOR"):
				print("1984 Medal for NOR!")
				m_1984 += 1
			elif (row[0] == "1988") and (row[4] == "NOR"):
				print("1988 Medal for NOR!")
				m_1988 += 1
			elif (row[0] == "1992") and (row[4] == "NOR"):
				print("1992 Medal for NOR!")
				m_1992 += 1
			elif (row[0] == "1994") and (row[4] == "NOR"):
				print("1994 Medal for NOR!")
				m_1994 += 1
			elif (row[0] == "1998") and (row[4] == "NOR"):
				print("1998 Medal for NOR!")
				m_1998 += 1
			elif (row[0] == "2002") and (row[4] == "NOR"):
				print("2002 Medal for NOR!")
				m_2002 += 1
			elif (row[0] == "2006") and (row[4] == "NOR"):
				print("2006 Medal for NOR!")
				m_2006 += 1
			elif (row[0] == "2010") and (row[4] == "NOR"):
				print("2010 Medal for NOR!")
				m_2010 += 1
			elif (row[0] == "2014") and (row[4] == "NOR"):
				print("2014 Medal for NOR!")
				m_2014 += 1
...
plt.plot(years, medalCounts, color="green", linewidth=5.0)
